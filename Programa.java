...
public class Programa {
    ...
    public static void main(String[] args){
        ...
        System.out.println("LISTA DE EXERCICIOS 1 - OPERADORES, TIPOS E CONDICIONAIS");
        System.out.println("------------------------------------------------------------");

        do {
            System.out.println("Informe o número da atividade que deseja rodar: 1 à 20 (ou 0 para sair)");
            n = Prompt.lerInteiro();
            ...
            switch (n) {
                ...
                default:
                    System.out.println("Informe um número de 1 à 20 ou 0 para sair!");
                    break;
            }
        } while (n != 0);
